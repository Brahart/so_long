...
/*   Updated: 2025/01/08 20:06:47 by asinsard         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	print_moves(t_data *data)
{
	...
	if (!moves)
	{
		ft_error("\e[1;31mERROR with itoa for display moves\n");
		end_game(data);
	}
	str = ft_strjoin("Moves: ", moves);
	if (!str)
	{
		ft_error("\e[1;31mERROR for join the strings of the moves display\n");
		end_game(data);
	}
